 ...
 */
export const SKILL_VERSION_BLUEPRINT = "_skill_version";
export const SKILL_FILE_BLUEPRINT = "_skill_file";
...
export const DEFAULT_SKILL_BLUEPRINT = "_skill";
export const DEFAULT_SKILL_GROUP_BLUEPRINT = "_skill_group";
